 ...
 * @param boundary: must be > sizeSearchWindow. Boundary kept around sub-images
 *                  when the image is subdivided for parallelization;
 ...
 * @param doPasteBoost: if true, patches near denoised similar patches
 *                      will not be used as reference patches;
 ...
 *
 * @param io_group3d: contains for each channels values of similar patches.
 *                    If an homogeneous area is detected, will contain
 *                    the average of all pixels in similar patches;
 ...
 * @param io_group3dBasic: contains values of similar patches for the basic image.
 *                         If an homogeneous area is detected, will contain the
 *                         average of all pixels in similar patches;
 * @param p_sP2: size of each patch (sP x sP);
 * @param p_nSimP: number of similar patches;
 * @param p_threshold: threshold below which an area is declared homogeneous;
 * @param p_imSize: size of the image.
 ...
 * @param io_group3dBasic: contains all similar patches in the basic image.
 *                         Will contain estimates for all similar patches;
