 ...
 *
 * @param io_mat : array containing a symmetric input matrix.
 *                 This is converted to the inverse matrix;
 * @param p_N : dimension of the system (dim(v)=n*n).
 *
 * @return EXIT_FAILURE if input matrix not positive definite, EXIT_SUCCESS otherwise.
 **/
int inverseMatrix(
 ...
 *
 * @param io_mat : pointer to an array of p_N by p_N input matrix io_mat.
 *                 This is overloaded by the transpose of io_mat;
